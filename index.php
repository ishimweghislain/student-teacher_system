...
<body>
    ...
    <center>
        <h1 style="color: #267860;" >Our Teachers</h1>
    </center>
    ...
    <div class="container">
       ...
       <div class="col-md-4">
         ...
         <p>We have world wide teachers who have an astonishing expreince of teaching which will be a good impact to your child.</p>
       </div>
       <div class="col-md-4">
       ...
       <p>We also don't give basic knowledge and skills to your child but also we give chances to study abroad and get interanational competitions.</p>
       </div>
        </div>
    </div>
    <center>
        <h1 style="color: #267860;">Our Courses</h1>
    </center>
    ...
    <center>
        <h1 style="color: #267860;">Admission Form !</h1>
    </center>
